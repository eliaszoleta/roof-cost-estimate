...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet><title>Privacy Policy | RoofingCal</title></Helmet>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '56px 24px', color: '#374151', fontSize: 15, lineHeight: 1.8 }}>
        ...
        <p>When you use RoofingCal, we may collect: ZIP code or state (to compute location-adjusted estimates), and optionally your name, email, and phone if you choose to provide them in the lead capture form. We also collect standard server logs (IP address, browser type, pages visited).</p>
